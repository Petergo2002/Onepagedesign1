...
export default function Testimonials() {
    ...
    // Use type assertion if testimonials are not typed in the data file, 
    // or ideally typed the data file. Assuming 'any' or matching structure for now.
                ...
                >
                    ...
                    <div className="mt-10 text-center">
                        <p className="text-white/60 text-sm">
                            Vill du dela din upplevelse? <Link href="/#offert" className="text-brand-300 hover:text-white transition-colors">Kontakta oss</Link>
                        </p>
                    </div>
                </div>
            </div>
