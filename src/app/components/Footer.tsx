    ...
    return (
        <footer className="pt-16 pb-10 border-t border-white/10 bg-gradient-to-t from-black to-transparent">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-10 items-start">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="mt-4 text-white/70 text-sm max-w-xs">
                            {industryCopy.footer.description}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2.5 text-sm text-white/70">
                            <li><Link href="/#tjanster" className="hover:text-brand-300 transition-colors">Tjänster</Link></li>
                            <li><Link href="/#omoss" className="hover:text-brand-300 transition-colors">Om oss</Link></li>
                            <li><Link href="/#omdomen" className="hover:text-brand-300 transition-colors">Omdömen</Link></li>
                            <li><Link href="/#offert" className="hover:text-brand-300 transition-colors">Begär offert</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="glass rounded-2xl p-6">
                        ...
                        <Link href="/#offert" className="inline-flex items-center justify-center px-6 py-2.5 rounded-full bg-brand-500 hover:bg-brand-600 text-white font-medium text-sm transition-colors w-full">
                            Begär offert
                        </Link>
                    </div>
                </div>
            ...
            <div className="container mt-12 pt-6 border-t border-white/10 text-sm text-white/50 flex flex-col md:flex-row items-center justify-between gap-4">
                <div>© {new Date().getFullYear()} {siteConfig.brandName} AB. Alla rättigheter reserverade.</div>
                <div className="space-x-4">
                    <Link href="/integritet" className="hover:text-white">Integritet</Link>
